...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and competitive games for basketball enthusiasts",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["natalie@mergington.edu", "aaron@mergington.edu"]
    },
    "Soccer Club": {
    ...
    "Drama Club": {
        "description": "Acting exercises, scene work, and theatrical performances",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments and discussions of scientific topics",
